...
The effective envelope is at most 8,192 bytes. Workflow/source/scope identity, authority, applicable invariants, frontier objective/effects, verifier requirements, and closure bindings are mandatory. Mandatory overflow is a blocker; optional evidence is omitted whole and reported by ID. Sensitive or credential-shaped content renders only a controlled pointer.
