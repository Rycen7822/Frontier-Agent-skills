...
class SkillContractTests(unittest.TestCase):
    ...
    def test_primary_development_entry_contract(self) -> None:
        ...
        self.assertIn("only scope completion receives the receipt-derived `--work-root`", skill)
        self.assertIn("source-relative selectors only", skill)
        self.assertIn("never include the owner root or any absolute path", skill)
