...
## Required inputs
- task context; two to four operator questions; failure/slow paths; ownership/dependency/state boundaries; current consumers; sensitive fields; volume/cardinality/retention/sampling; backend degradation; overhead budget; role/health/progress/retry/cancel/recovery contract.
