...
## Required inputs
- task context; supported content/escaping/table/delimiter contract, raw-content trust boundary, parser/renderer order, CSP/sanitizer and sinks, synthetic malicious/edge fixtures, trusted target, DOM/overflow viewport, and safe logging boundary.
