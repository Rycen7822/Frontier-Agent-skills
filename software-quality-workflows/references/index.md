...
Read only for a concrete specialist risk. Select one reference; a second requires an independent material risk.

| Trigger | Direct reference |
|---|---|
| Unknown cause or intent | [diagnosis](diagnosis/evidence-and-hypothesis.md) or [intent](intent/discovery-and-freeze.md) |
| Scope/authority or verifier integrity | [scope](control/scope-authority-and-effects.md) or [evidence](control/evidence-and-verifier-integrity.md) |
| Behavior/test retention ambiguity | [behavior evidence](test/behavior-evidence.md) or [suite lifecycle](test/test-suite-lifecycle.md) |
| API or architecture | [API migration](domain/api/contract-and-migration.md) or [architecture](domain/architecture/boundaries-and-alternatives.md) |
