...
Use when scope, protected work, external effects or evidence validity is uncertain.
...
Choose the lowest-cost independent observation that decides the claim. Complete coherent edits before checking; use the final consumer when an internal check cannot establish actual behavior. Preserve requirements and meaningful oracle strength when a test fails. Local proof and release authority remain separate.
