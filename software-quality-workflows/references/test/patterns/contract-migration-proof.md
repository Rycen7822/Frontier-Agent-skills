...
## Use when
- task context identifies a retired name, payload, schema, alias, state identity or behavior, or optional schema differences cause false refresh/rewrite despite approved semantic equivalence.
