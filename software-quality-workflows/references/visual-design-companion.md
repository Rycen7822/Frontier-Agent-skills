...
```text
command: <skill-root>/scripts/design-discovery/start-server.sh [--project-dir <project-root>]
...
```text
command: <skill-root>/scripts/design-discovery/stop-server.sh <session_dir>
```
