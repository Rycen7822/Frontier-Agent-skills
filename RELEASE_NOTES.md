...
Relative to the unpublished Bundle 8.0.0 draft, the only semantic delta is Software Quality Workflows 11.0.1 becoming explicit-only; source-complete and local smoke still do not grant qualification, authorization, installation, publication, or deployment authority.
