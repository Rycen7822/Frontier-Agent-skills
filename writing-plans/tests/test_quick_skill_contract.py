...
class QuickWritingPlansTests(unittest.TestCase):
    ...
    def test_minimal_sufficient_plan_and_execution_contract(self) -> None:
        ...
        for contract in (
            ...
            "no second frontier, milestone, acceptance",
            "every settled observable behavior needed by the first slice",
            "never replace settled behavior with a symbol name",
            "program keeps its milestone sequence inside slice",
