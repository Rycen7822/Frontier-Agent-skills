...
class ReferenceCardsV5Tests(unittest.TestCase):
    ...
    def test_builder_rejects_orphan_mapping_and_missing_selector_fixture(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            shutil.copy2(ROOT / "tests" / "fixtures" / "decision-route-cases-v5.json", target / "tests" / "fixtures")
            ...
            fixtures = json.loads((target / "tests" / "fixtures" / "decision-route-cases-v5.json").read_text(encoding="utf-8"))
