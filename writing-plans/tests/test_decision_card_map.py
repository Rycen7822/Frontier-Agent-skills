...
class WritingPlanRouteSequenceTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.selector_fixture = self._load("tests/fixtures/decision-route-cases-v5.json")
    ...
    def test_sequence_fixture_consumes_the_single_decision_map(self) -> None:
        ...
        self.assertEqual(
            "tests/fixtures/decision-route-cases-v5.json",
    ...
    def test_entry_routes_and_outcome_links_are_executable(self) -> None:
        ...
        for sequence in self.sequence_fixture["workflow_sequences"]:
            ...
            self.assertEqual("software-quality-workflows", terminal["owner"])
