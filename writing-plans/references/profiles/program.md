...
- Each ordered phase or milestone with dependencies and independently observable proof.
...
Each ordered phase or milestone describes outcomes rather than horizontal implementation layers. Proof gates name observable evidence without claiming it has run.
