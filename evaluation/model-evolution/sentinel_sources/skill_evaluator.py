...
DEFINITION = {
    ...
    "grader_rules": [
        ...
        "For skill-evaluator-level-owner-selection, quality and process pass when the answer selects L1 for the completed execution receipt, keeps any receipt-validity diagnosis at L1, and explains why L2-L4 are unnecessary; a hedged schema observation does not fail the owner selection.",
        ...
        "For skill-evaluator-transition-vs-revision, quality and process pass when A is classified as a model-transition comparison, B as a controlled Skill-revision comparison, and Host, tasks, grader, and policy are all frozen. An explicit L4 label is optional and, when present, follows the Skill's level table rather than adding unsupported content.",
