...
DEFINITION = {
    ...
    "grader_rules": [
        ...
        "For skill-evaluator-transition-vs-revision, quality and process pass when A is labeled an L4 model-transition comparison, B is labeled an L4 Skill-revision comparison, and Host, tasks, grader, and policy are all frozen; those L4 labels follow the Skill's level table and are not unsupported extras.",
