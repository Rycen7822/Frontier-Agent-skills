...
DEFINITION = {
    ...
    "grader_rules": [
        ...
        "For writing-plans-protected-description, quality and process pass for a forward-looking plan that changes only the version, preserves the complete observed description verbatim, and verifies both lines with exact assertions; plan imperatives are not completion claims.",
