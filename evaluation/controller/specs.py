...
MODEL_CHECKS = {
    ...
    "writing-plans": (
        ...
        ("no-invented-decision", "quality", "No unresolved product, architecture, owner, or supplied value is invented; conservative evidence gates may follow stated invariants, and unknown facts gate only dependent later milestones."),
        ...
        ("no-hard-wraps", "quality", "No newline splits a prose sentence; Markdown structural boundaries are allowed."),
...
def _writing_plan_gates(phase: str) -> list[dict[str, Any]]:
    ...
    if phase == "D0":
        return [
            ...
            gate("WP-D0-16", arm, "all_context_minimum_relative_effect", "ge", -0.02),
    ...
    return [
        ...
        gate("WP-F-09", arm, "all_context_minimum_relative_effect", "ge", -0.02),
        gate("WP-F-10", arm, "authoritative_body_consumed_exactly_once", "eq", True),
        gate("WP-F-11", arm, "authority_reference_loads_max", "eq", 0),
        gate("WP-F-12", arm, "protocol_only_calls", "eq", 0),
        gate("WP-F-13", arm, "planner_quality_absolute_effect", "ge", -0.03, selector="lower"),
