...
- [Evaluation spec v7](eval-spec-v7.schema.json)
- [Scenario v1](scenario-v1.schema.json)
- [Execution plan v3](execution-plan-v3.schema.json)
...
- [Analysis summary v6](analysis-summary-v6.schema.json)
- [Failure index v2](failure-index-v2.schema.json)

The opt-in offline comparison path adds:

- [Comparison cycle capsule v3](comparison-cycle-capsule-v3.schema.json)
- [Comparison plan v3](comparison-plan-v3.schema.json)
- [Comparison observations v2](comparison-observations-v2.schema.json)
- [Comparison report v3](comparison-report-v3.schema.json)
