...
Use the same receipt-index v1 and receipt v1 contract as L1–L3. For each compared version, bind package, catalog, treatment, fixture, grader, artifact, provenance, routing, usage, and context evidence.
